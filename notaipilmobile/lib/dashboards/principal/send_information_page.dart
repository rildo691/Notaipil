...
class SendInformationPage extends StatefulWidget {
  ...
  SendInformationPage(this.principal);
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: (){
                                  if (key.currentState!.validate()){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => SelectCoordinatorPage(widget.principal, [{'subject': _subjectController.text, 'message': _messageController.text}])));
                                  }
                                },
                              )
                            ),
