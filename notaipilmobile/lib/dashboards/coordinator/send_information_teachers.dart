...
/**Complements */
import 'package:notaipilmobile/dashboards/coordinator/select_teachers_page.dart';
...
class SendInformationTeachers extends StatefulWidget {
  ...
  SendInformationTeachers(this.coordinator);
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: (){
                                  if (_key.currentState!.validate()){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => SelectTeachersPage(widget.coordinator, [{'subject': _subjectController.text, 'message': _messageController.text}])));
                                  }
                                },
                              )
                            ),
