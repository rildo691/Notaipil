                    ...
                    switch(snapshot.connectionState){
                      ...
                      default:
                        if(snapshot.hasError){
                          ...
                          width: SizeConfig.screenWidth,
                          height: students.length < 7 ? students.length < 5 ? SizeConfig.screenHeight !- students.length * 35 : SizeConfig.screenHeight !* students.length / 5.2 : SizeConfig.screenHeight !* students.length / 25,
                          color: Color.fromARGB(255, 34, 42, 55),
                          child: Column(
