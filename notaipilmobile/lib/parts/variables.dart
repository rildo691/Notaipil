...
const Color appBarColor = backgroundColor;
const Color appBarLetterColorAndDrawerColor = Colors.white;
const Color drawerColor = backgroundColor;
const Color drawerLetterColor = letterColor;
